...
An exercise was done to detect, correlate, and create alerts for brute force attacks. Multiple failed authentications attempts were carried out against a privileged account in a lab environment to test this capability.
...
The aim of this exercise was to verify the detection and correlation of the lab environment's SOC.
...
In order to generate multiple event IDs for failed authentication, invalid credentials were passed on.
...
The above-mentioned activity corresponds to brute force attack activity towards a privileged account.
...
The goal of the simulated activity was gaining access using password guessing.
...
- Checking an alert being delivered to Discord.
- Identifying the simulation activity.

## Conclusion

A successful simulation of a brute force attack on a privileged account was performed in the SOC lab.
